...
public class OtherTestRemoteViewImplementation implements RemoteViewInterface {
    String username;

    public OtherTestRemoteViewImplementation(String username) {
    ...
    public void setChat(ChatModel chat) throws RemoteException {
        System.out.print("[OTHER " + username + "]: Chat updated!\n");
